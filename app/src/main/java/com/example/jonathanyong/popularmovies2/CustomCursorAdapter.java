...
public class CustomCursorAdapter extends RecyclerView.Adapter<CustomCursorAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        int descriptionIndex = mCursor.getColumnIndex(TaskContract.TaskEntry.COLUMN_MOVIE);
        int priorityIndex = mCursor.getColumnIndex(TaskContract.TaskEntry.COLUMN_FAVOURITE);
        ...
        holder.priorityView.setText(Integer.toString(id));
...
//    }
    ...
    class TaskViewHolder extends RecyclerView.ViewHolder {
        ...
        public TaskViewHolder(View itemView) {
            ...
            taskDescriptionView = (TextView) itemView.findViewById(R.id.movieTitle);
            priorityView = (TextView) itemView.findViewById(R.id.favourite);
        }
    }
}